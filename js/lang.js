window.language = {
    EN: {
        ...
        MISSIONS: {
            0: ['White Light', 'A white light dazzles you but you quickly understand that this place is not the Earth, no walls, no sky... But blinding lights all around you. It\'s time to wake up !'],
            1: ['Shadow Forest', 'You are now in an unknown forest... A dark and creepy forest with no one in sight.You decide to leave that place right now, even at the risk of losing your life.'],
            2: ['Lost Path', 'You arrive at the end of the forest and discover a little path hidden behind a big tree.There seems to be a light in the distance and perhaps finally some answers.'],
            3: ['Galarius City', 'You reach a city with many people from a variety of different races: humans, dwarves and even elves.It seems like you might be able to find some help here... or maybe just someone who can tell you how to get back to your world.'],
            4: ['Endless mountain', 'One of the locals advises you to go north and reach the royal capital through the mountains...So here you are in the so-called "endless" mountains.'],
            5: ['Dark Cave', 'You arrive at the entrance of a dark cave.It seems narrow but it is much faster and less dangerous than the mountains.'],
            6: ['Empire Road', 'You finally reach the end of the cave, tired but in one piece.You can already see a sprawling city at the end of the road.'],
            7: ['Imperium City', 'You arrive at the Capital; the king, having heard about your story, demands an immediate hearing.'],
            8: ['Central V', 'You discuss finding a way to return to your world with the king.He informs you that the only way is through the Red Portal on the farm side of the nearby demon army.You\'ll need to get there quickly before the demons swarm you!'],
            9: ['The Red Portal', 'The red portal is near and burns white-hot like the gates of hell.Lacking any better options you head closer.'],
            10: ['Corrupted World', 'You have successfully passed through the portal... But where have you arrived?'],
            11: ['Corrupted Dungeon', 'You see a huge fortress full of nothing but demons; you feel the need to cleanse this place.'],
            12: ['Corrupted Dungeon - Basement', 'There is a door inside that leads downwards to another level; you feel the need to cleanse this place too.'],
            13: ['Corrupted Dungeon - Core', 'On the final floor you find the Dungeon Core, where the corruption started... Destroy it.'],
            14: ['The Luminous Portal', 'Just after you destroyed the Dungeon Core another portal appears, this one black and cold as ice.<center>A new story begins.</center>'],
            15: ['The Luminous Portal II', 'As you move forward the passage becomes even darker and colder.You can just make out a light far in the distance...'],
            16: ['Light of Elysia', 'Exiting the other side of the portal you land in a new world in the city of Elysia.This world seems quite beautiful; why not explore it for awhile?'],
            17: ['Red Moon at Elysia', 'Elysia is lively, peaceful, and filled solely by humans as far as you can tell.As you wander the city you hear a cry; when you arrive at the sound you see a man sucking someone\'s blood in the shadow of an alley... a vampire!'],
            ...
            21: ['Red River', 'During your daily hunt you find a merchant who keeps repeating that the vampire attack in the city was only the beginning.He also shares a rumor: the vampire\'s castle is said to be hidden somewhere in the mountains.'],
            22: ['The Mountains', 'After searching for five days in the mountains you find a bridge filled with corpses.Without any hesitation you start to cross the bridge into vampire territory.'],
            23: ['Immortals Valley', 'These vampires seem more difficult to kill than the ones in the city.An enormous castle looms at the end of the bridge so you continue to fight through them.'],
            24: ['Vampire Castle', 'This is it: The Vampire Castle.Now that you have arrived it\'s time to cleanse this filthy place.'],
            25: ['Vampire Castle - Tower', 'You discover that one of the towers in the castle houses many powerful vampires.This may take longer than you had hoped to clean up.'],
            26: ['Vampire Castle - Core', 'You have reached the Castle Heart. By destroying the Heart this world has nearly reached the peace.But first you\'ll need to kill the remaining vampires that guard it!'],
        },
        LOCATIONS: {
            0: "The White Light",
            1: "The Shadow Forest",
    ...
    FR: {
        ...
        MISSIONS: {
            0: ['Lumière Blanche', 'Une lumière blanche vous éblouit mais vous comprennez très vite que cet endroit n\'est pas la Terre, aucun murs, aucun ciel... Mais des lumières aveuglantes partout autour de vous. Il est temps de se réveiller.'],
            1: ['Forêt des Ombres', 'Vous êtes maintenant dans une forêt inconnue... Une forêt sombre et glauque sans personne en vue.Vous décidez de vite partir de là, au risque d\'y perdre la vie.'],
            2: ['Chemin Perdu', 'Vous arrivez au bout de la forêt et découvrez un petit chemin caché derrière un grand arbre.Il semble y avoir une lumière au loin et peut-être enfin des réponses.'],
            3: ['Ville de Galarius', 'Vous arrivez dans une ville où vivent de nombreuses personnes de races différentes : Humains, Nains et même des Elfes.Il semble que vous puissiez trouver une aide ici... ou peut-être simplement une personne qui puisse vous dire comment retourner dans votre monde.'],
            4: ['Montagne sans Fin', 'Un des habitants vous conseille de partir vers le nord et de rejoindre la capitale royale en passant par les montagnes.Vous voilà donc dans les montagnes dites "sans fin".'],
            5: ['Grotte Obscure', 'Vous arrivez à l\'entrée d\'une obscure grotte.Elle semble étroite mais elle est beaucoup plus rapide et moins dangereuse que les montagnes.'],
            6: ['Route Impériale', 'Vous arrivez enfin au bout de la grotte, fatigués mais en un seul morceau.Vous apercevez déjà une ville immense au bout de la route.'],
            ...
            8: ['Central V', 'Vous discutez avec le roi pour trouver un moyen de retourner dans votre monde. Il vous informe que le seul moyen est de passer par le portail rouge du côté de la ferme de l\'armée des démons à proximité.Vous devrez vous y rendre rapidement avant que les démons ne vous assaillent !'],
            9: ['Portail Rouge', 'Le portail rouge est proche et brûle à blanc comme les portes de l\'enfer. Sans meilleure option, vous vous rapprochez.'],
            ...
            14: ['Portail Lumineux', 'Juste après avoir détruit le noyau de la forteresse, un nouveau portail apparaît.<center>Et avec lui, une nouvelle histoire commence...</center>'],
            15: ['Portail Lumineux II', 'En avançant, le passage devient encore plus obscur et froid. On peut seulement distinguer une lumière au loin...'],
            16: ['Lumière d\'Elysia', 'En sortant de l\'autre côté du portail, vous atterrissez dans un nouveau monde, dans la ville d\'Elysia.Ce monde semble relativement beau; pourquoi ne pas l\'explorer un peu ?'],
            17: ['Lune Rouge à Elysia', 'Elysia est une ville vivante, paisible et remplie uniquement d\'humains pour autant que vous puissiez en témoigner.En parcourant la ville, vous entendez un cri; En arrivant au son, vous voyez un homme sucer le sang de quelqu\'un dans l\'ombre d\'une ruelle... Un Vampire !'],
            ...
            21: ['La Rivière Rouge', 'Au cours de votre chasse quotidienne, vous trouvez un marchand qui ne cesse de répéter que l\'attaque de vampires dans la cité n\'était que le début.Il partage également une rumeur : Le château du vampire serait caché quelque part dans les montagnes.'],
            22: ['Les Montagnes', "Après avoir cherché pendant cinq jours dans les montagnes, vous trouvez un pont rempli de cadavres.Sans aucune hésitation, vous commencez à emprunter le pont pour accéder au territoire des vampires."],
            23: ['Vallée des Immortels', "Ces vampires semblent plus difficiles à tuer que ceux de la cité.Un énorme château se profile au bout du pont, vous continuez donc à vous battre pour le franchir."],
            ...
            25: ['Château des Vampires - Tour', 'Vous découvrez qu\'une des tours du château abrite de nombreux et puissants Vampires.Cela va prendre plus de temps que vous ne le pensiez pour faire le ménage.'],
            26: ['Château des Vampires - Noyau', 'Vous avez atteint le noyau; en détruisant celui-ci, ce monde aura presque enfin atteint la paix.Mais d\'abord, vous devrez tuer les vampires qui le protège encore !'],
        },
        LOCATIONS: {
