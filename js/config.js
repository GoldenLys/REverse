const GLOBALS = {
    ...
    MISSIONS:
    {
        ...
        17: ["Red Moon at Elysia", 'This city really is lively and  there are only humans here, so far peace reigns so you decide to wander around the city.<br> But suddenly you hear a cry, while arriving near that sound, in the shadow of an alley you see a man sucking the blood of someone.. a vampire is right in front of you.', 31, 1, 10, 50000, 0, "Exotic", 13, 16],
        18: ["Vampire Manor", 'One of the vampires confess the location of a vampire hideout, you will surely find informations there.', 32, 1, 10, 75000, 0, "Exotic", 14, 17],
        ...
        21: ["The Red River", 'During your daily hunt you find a merchant who keeps saying that the vampire attack in the city was only the beginning.<br> He also tells you that a rumor says that their castle is said to be hidden in the mountains.', 33, 1, 10, 150000, 0, "Exotic", 15, 20],
    ...
    LOCATIONS: {
        //    0             1                   2                            3                                    4                           5                        6
        //NAME, MIN-LEVEL, MAX-LEVEL, MAX DROP QUALITY, MISSION REQUIRED, LOOTS (WIP), BACKGROUND
